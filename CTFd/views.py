...
def setup():
    ...
    <div class="col-md-6 offset-md-3">
        ...
        <h3 class="text-center">
            <p><a href="https://ctfd.io">ctfd.io</a></p>
            <p>Funciona:</p>
            <a href="https://unl.edu.ec"><i class="fab fa-twitter fa-2x" aria-hidden="true"></i></a>&nbsp;
            <a href="https://unl.edu.ec"><i class="fab fa-facebook fa-2x" aria-hidden="true"></i></a>&nbsp;
            <a href="https://unl.edu.ec"><i class="fab fa-github fa-2x" aria-hidden="true"></i></a>
        </h3>
        <br>
        <h4 class="text-center">
            <a href="admin">Click aqui</a> to login and setup your CTF
        </h4>
    </div>
</div>"""
